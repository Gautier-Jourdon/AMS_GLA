...
| US8 | Structuration des logs (timestamp, id, valeur)      | A faire        |
| US9 | Configuration Jest de base                          | Fait           |
| US10| Tests sur `assets.json` / fetcher                   | A faire        |
| US11| Tests erreurs API / cron                            | A faire        |
| US12| Dockerfile fonctionnel                              | Fait           |
