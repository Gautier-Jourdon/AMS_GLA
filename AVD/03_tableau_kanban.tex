...
\title{Tableau Kanban\\Projet AMS GLA}
...
Enfin, il est important de se donner une définition claire de ce que signifie « Fait » pour une User Story. Dans ce projet, une tâche est considérée comme terminée lorsque le code est écrit, que l’application s’exécute sans erreur et que les tests pertinents passent avec succès. Une petite trace documentaire, sous forme de commentaire dans le code ou de note dans le rapport, vient idéalement compléter ce triptyque. En ajoutant dans le rapport un court historique de l’évolution de ce tableau Kanban, semaine par semaine, on montre la continuité de l’organisation et la progression concrète du projet.
